...
namespace Library
{
	public class LibraryBot : ModuleBase
	{
		...
		public async Task Help()
		{
			await Context.Channel.SendMessageAsync("Roll some dice! Commands:\n"
				+ "**!d4 [number]** | Roll a d4 number times.\n"
				+ "**!d6 [number]** | Roll a d6 number times.\n"
				+ "**!d8 [number]** | Roll a d8 number times.\n"
				+ "**!d10 [number]** | Roll a d10 number times.\n"
				+ "**!d12 [number]** | Roll a d12 number times.\n"
				+ "**!d20 [number]** | Roll a d20 number times.\n"
				+ "**!d100 [number]** | Roll a d100 number times.\n\n"
